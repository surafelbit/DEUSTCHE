...
// const BatchesEditor = () => {
//   // FAKE DATA - simulates API response
//   const fakeBatches = [
//     { id: 1, batchName: "2024A" },
//     { id: 2, batchName: "2024B" },
//     { id: 3, batchName: "2024C" },
//     { id: 4, batchName: "2025A" },
//     { id: 5, batchName: "2025B" },
//     { id: 6, batchName: "2023A" },
//     { id: 7, batchName: "2023B" },
//     { id: 8, batchName: "Special Batch" },
//   ];
...
//     // Simulate API delay
//     setTimeout(() => {
//       const transformed = fakeBatches.map((item) => ({
//         id: item.id,
//         name: item.batchName,
//       }));
...
//     navigate(`/registrar/settings/batches/${item.id}`);
//   };
...
//     setTimeout(() => {
//       if (editingItem) {
//         const transformed = { id: editingItem.id, name: formData.name };
//         setData(data.map((d) => (d.id === editingItem.id ? transformed : d)));
//       } else {
//         const newId = Math.max(...data.map((d) => d.id)) + 1;
//         const transformed = { id: newId, name: formData.name };
...
// // Single Batch Detail Page with FAKE data
...
//   // FAKE single batch data
//   useEffect(() => {
//     setTimeout(() => {
//       const fakeBatch = {
//         id: parseInt(id),
//         name: `2024${String(parseInt(id)).padStart(1, "A")}`,
//         description: `Comprehensive details about ${`2024${String(
//           parseInt(id)
//         ).padStart(
//           1,
//           "A"
//         )}`}. This batch includes student records, attendance tracking, and performance analytics.`,
//         createdAt: "2025-01-15",
//         studentCount: 45 + parseInt(id),
//       };
//       setBatch(fakeBatch);
//       setFormData({ name: fakeBatch.name });
//       setLoading(false);
//     }, 800);
//   }, [id]);
...
//       return;
//     }
//     setBatch({ ...batch, name: formData.name });
//     handleCloseModal();
//   };
