...
//   // Add more if needed or fetch dynamically via API if possible
// ];
...
//       // Refresh data
//       const response = await apiService.get("/api/program-modality");
//       setData(response);
//       handleCloseModal();
//     } catch (err: any) {
...
//               className="w-full mb-4 p-4 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
//             />
//             <input
//               type="text"
//               name="modality"
...
//               onChange={handleChange}
//               className="w-full mb-6 p-4 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
//             >
...
//                 className="px-6 py-3 rounded-lg bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-700 font-semibold transition"
//               >
//                 Cancel
//               </button>
//               <button
