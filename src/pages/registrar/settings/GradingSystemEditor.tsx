...
// const fakeGradingSystems: GradingSystem[] = [
//   {
//     id: 1,
//     versionName: "2025 Revised",
//     departmentId: 5,
//     remark: "Updated pass thresholds",
//     intervals: [
//       {
//         id: 101,
...
//   {
//     id: 2,
//     versionName: "2024 Standard",
//     departmentId: null,
//     remark: "Global baseline",
//     intervals: [
//       {
//         id: 90,
//         description: "Excellent",
...
//       try {
//         setGradingSystems(fakeGradingSystems);
//       } catch (e) {
//         setError("Failed to load grading systems.");
//       } finally {
//         setLoading(false);
//       }
//     }, 700);
...
//   const handleOpenModal = (item: GradingSystem | null = null) => {
...
//         (interval as any)[field] = Number(value);
//       } else {
...
//     // Optional: check overlapping intervals
...
//     if (!editingItem && !window.confirm("Add this new grading system?")) {
//       return;
//     }

//     if (editingItem) {
//       setData((prev) =>
//         prev.map((d) => (d.id === editingItem.id ? formData : d))
//       );
//     } else {
//       const newId =
//         data.length > 0 ? Math.max(...data.map((d) => d.id)) + 1 : 1;
//       const intervalsWithIds = formData.intervals.map((int, idx) => ({
//         ...int,
//         id: int.id ?? 200 + idx,
//       }));
...
//                     className="px-3 py-2 text-xs rounded-lg bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300"
//                   >
//                     Remove
//                   </button>
//                 </div>
...
//               className="mb-6 px-4 py-2 rounded-full bg-green-600 text-white text-sm font-semibold hover:bg-green-700"
//             >
//               + Add Interval
//             </button>
...
const CrudSection = ({
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await apiService.delete(`${endPoints.gradingSystems}/${id}`);
      setData((prev) => prev.filter((d) => d.id !== id));
    } catch (e: any) {
